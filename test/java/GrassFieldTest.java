...
public class GrassFieldTest {
    ...
    void testIsOccupied() {
        ...
        map.place(new Animal(map,new Vector2d(4,3)));
        map.place(new Animal(map,new Vector2d(100,-100)));
        map.elements.put(new Vector2d(5,6),new Grass(new Vector2d(5,6)));
        map.elements.put(new Vector2d(50,6),new Grass(new Vector2d(50,6)));
    ...
    void testObjectAt(){
        ...
        map.place(animal2);
        map.place(animal3);
        map.elements.put(grass1.getPosition(),grass1);
        map.elements.put(grass2.getPosition(),grass2);
